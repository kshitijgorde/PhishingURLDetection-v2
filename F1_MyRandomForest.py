...
class F1_MyRandomForestClassifier():
    ...
    def randomForestNoOversampling(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsNoOversampling.txt',
            'a+')
        ...
        try:
            ...
            clf = GridSearchCV(estimator, parameters_RandomForest, n_jobs=15)
    ...
    def randomForestSMOTE(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsSmote.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
    ...
    def randomForestb1SMOTE(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsb1Smote.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
    ...
    def randomForestb2SMOTE(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsb2Smote.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
    ...
    def randomForestSVM_Smote(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsSVMSmote.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
    ...
    def randomForestRMR(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique, OUTPUT_START):
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsRMR.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
    ...
    def randomForestADASYN(self, featureMatrix, phishingURLLabel, fakeFeatureMatrix, fakeLabels, technique,
        ...
        dir_name = os.path.dirname(os.path.realpath(__file__))
        predictionResult = open(
            dir_name + '/F1_Scores/' + OUTPUT_START + '-' + technique + 'F1_RandomForestResultsADASYN.txt', 'a+')
        predictionResult.truncate()
        accuracy_matrix = []
        try:
            URL_Train, URL_Test, Label_Train, Label_Test = train_test_split(featureMatrix, phishingURLLabel,
